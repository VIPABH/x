   ...
   if text == 'المجموعه' or text == 'المجموعة':
       ...
       if m.chat.photo:
           ...
           try:
               ...
               return m.reply(f'فشل تحميل صورة المجموعة: {str(e)}')
       else:
        type = 'text'
       ...
       if type == 'photo':
           try:
            ...
            return m.reply(f'حدث خطأ أثناء إرسال الصورة: {str(e)}')
       else:
